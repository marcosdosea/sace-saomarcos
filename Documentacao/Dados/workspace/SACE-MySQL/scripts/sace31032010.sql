...
CREATE TABLE SACE.TB_PRODUTO (
     ...
     , custoVenda DECIMAL(10, 4) DEFAULT 0
     , ultimoPrecoCompra DECIMAL(10, 4) DEFAULT 0
     , ultimaDataAtualizacao DATE
     , ultimoPrecoCusto DECIMAL(10, 4) DEFAULT 0
     , ultimoPrecoMedio DECIMAL(10, 4) DEFAULT 0
     , lucroPrecoVendaVarejo DECIMAL(5, 2) DEFAULT 0
     , precoVendaVarejo DECIMAL(10, 4) DEFAULT 0
     , qtdProdutoAtacado DECIMAL(10, 2) DEFAULT 0
     , lucroPrecoVendaAtacado DECIMAL(5, 2) DEFAULT 0
     , precoVendaAtacado DECIMAL(10, 4) DEFAULT 0
     , qtdProdutoSuperAtacado DECIMAL(10, 2) DEFAULT 0
     , lucroPrecoVendaSuperAtacado DECIMAL(5, 2) DEFAULT 0
     , precoVendaSuperAtacado DECIMAL(10, 4) DEFAULT 0
     , exibeNaListagem BOOLEAN DEFAULT true
