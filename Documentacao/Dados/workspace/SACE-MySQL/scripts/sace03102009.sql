...
DROP TABLE IF EXISTS SACE.TB_PRODUTO_PRECOS;
...
CREATE TABLE SACE.TB_PRODUTO_PRECOS (
       codProduto BIGINT NOT NULL
     ...
     , INDEX (codProduto)
     , CONSTRAINT FK_TB_PRODUTO_PRECOS_1 FOREIGN KEY (codProduto)
                  REFERENCES SACE.TB_PRODUTO (codProduto)
);
