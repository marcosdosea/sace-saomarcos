...
namespace Util
{
    public static class Global
    {
        ...
        public static String
         ...
         PASTA_COMUNICACAO_NFCE_RECEBER  = ENDERECO_SERVIDOR + "MKS\\CAIXA1\\RECEBER\\",
         PASTA_COMUNICACAO_NFCE_DEVOLVER = ENDERECO_SERVIDOR + "MKS\\CAIXA1\\DEVOLVER\\",
         PASTA_COMUNICACAO_NFCE_XML = ENDERECO_SERVIDOR + "MKS\\CAIXA1\\XMLPRODUCAO\\",
