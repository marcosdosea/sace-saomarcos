...
namespace Negocio
{
    public class GerenciadorPontaEstoque
    {
        ...
        private static GerenciadorPontaEstoque gPontaEstoque;

        public static GerenciadorPontaEstoque GetInstace()
        {
            if (gPontaEstoque == null)
            {
                gPontaEstoque = new GerenciadorPontaEstoque();
            }
            return gPontaEstoque;
        }
